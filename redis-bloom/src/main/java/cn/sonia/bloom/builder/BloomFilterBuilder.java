package cn.sonia.bloom.builder;

import cn.sonia.bloom.hash.HashFunction;
import cn.sonia.bloom.hash.MurMur3HashFunction;
import cn.sonia.bloom.impl.BloomFilterImpl;
...
public class BloomFilterBuilder {
    ...
    public <T> BloomFilterImpl<T> build() {
